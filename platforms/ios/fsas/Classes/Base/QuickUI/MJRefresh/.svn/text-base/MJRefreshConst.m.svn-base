...
NSString *const MJRefreshFooterPullToRefresh = @"上拉即可刷新";
NSString *const MJRefreshFooterReleaseToRefresh = @"释放即可刷新";
NSString *const MJRefreshFooterRefreshing = @"加载中";

NSString *const MJRefreshHeaderPullToRefresh = @"上拉即可刷新";
