...
// QDS修改
// static NSString * const kOpenUDIDDescription = @"OpenUDIDWeiCaiFu_with_iOS6_Support";
static NSString * const kOpenUDIDKey = @"OpenUDIDWeiCaiFu";
static NSString * const kOpenUDIDSlotKey = @"OpenUDIDWeiCaiFu_slot";
static NSString * const kOpenUDIDAppUIDKey = @"OpenUDIDWeiCaiFu_appUID";
static NSString * const kOpenUDIDTSKey = @"OpenUDIDWeiCaiFu_createdTS";
static NSString * const kOpenUDIDOOTSKey = @"OpenUDIDWeiCaiFu_optOutTS";
static NSString * const kOpenUDIDDomain = @"org.OpenUDIDWeiCaiFu";
static NSString * const kOpenUDIDSlotPBPrefix = @"org.OpenUDIDWeiCaiFu.slot.";
...
# error                                                         ^ read comments above, fix accordingly, and remove this #error line
    ...
    if (_openUDID==nil) {
        ...
        _openUDID = [NSString stringWithFormat:
                @"i%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%08x",
