$(function () {
    ...
    $("#refundApply").on("panelload", function (e) {
        ...
        $("#refundApplyCode").off("tap").on("tap", function() {
            ...
            svc.forgerPassSend(refundMobile, function(r){
    ...
    $("#addressConfirm").on("panelload", function (e) {
        ...
        $(".qrshSubmit").off("tap").on("tap", function () {
            ...
            if (validStatus) {
                ...
                hlp.panelObj["infoEdit"].address = $(".acAddress").val();
...
// 获取选中的地址
var getSelectAddressInfo = function() {
             ...
             if (type == 0) {
                 switch(Number(r.data.order_info.code)) {
                     case 1: // 待付款
                         ...
                         $("#unpayedOrder_invContent")[0].innerHTML = "发票信息："+r.data.order_info.inv_content;
                     ...
                     case 2: // 已付款
                         ...
                         $("#orderDtl1_invContent")[0].innerHTML = "发票信息："+r.data.order_info.inv_content;
                     ...
                     case 3: // 已发货
                         ...
                         $("#orderDtl2_invContent")[0].innerHTML = "发票信息："+r.data.order_info.inv_content;
                     ...
                     case 4: // 已取消
                         ...
                         $("#orderDtl3_invContent")[0].innerHTML = "发票信息："+r.data.order_info.inv_content;
                     ...
                     case 5: // 已完成
                         ...
                         $("#orderDtl4_invContent")[0].innerHTML = "发票信息："+r.data.order_info.inv_content;
...
var setReturnApply = function() {
    ...
    $(".sqthSubmit").off("tap").on("tap", function () {
        ...
        /*if (isChkCount == "0") {
            ...
            var return_data = {
                "order_sn": hlp.panelObj["orderSn"].order_sn,
                "user_id": loj.UserId,
                "receiver_address": {
